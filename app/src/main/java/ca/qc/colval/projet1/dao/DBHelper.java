...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE VIEW IF NOT EXISTS viewCheck_Account AS select BankAccounts.acc_num AS  acc_num, Checks.check_num as checks_num, Checks.idch as idch, Checks.isPaid as isPaid FROM Expenses JOIN BankAccounts on Expenses.idcb = BankAccounts.idcb join Checks on Expenses.idd = Checks.idd");
    }
