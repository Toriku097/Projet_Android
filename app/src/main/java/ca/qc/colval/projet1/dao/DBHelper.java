...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS BankAccounts (idcb INTEGER PRIMARY KEY, acc_num TEXT, bank TEXT, funds REAL)");
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS Checks (idch INTEGER PRIMARY KEY, check_num INTEGER, date TEXT, amount REAL, idd INTEGER, idp INTEGER, FOREIGN KEY(idd) REFERENCES Expenses(idd), FOREIGN KEY(idp) REFERENCES Projects(idp))");
